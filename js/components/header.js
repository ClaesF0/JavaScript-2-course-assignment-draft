...
function createHeaderBar() {
  ...
  if (navBar) {
    ...
    if (userName) {
      links = `
    <li>
      <a href="index.html" class="block py-2 p-1  text-white hover:bg-gray-100 md:hover:bg-transparent bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white" aria-current="page">Feed </a>
    </li>
      <a href="my-posts.html" class="block py-2 p-1  text-white hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-white dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700"> My posts </a>
    </li>
    <li>
      <a href="profile.html" class="block py-2 p-1  text-white hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-white dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700"> ${userName}'s profile </a>
    </li>     
`;
    }
    navBar.innerHTML = `
    <nav class="px-2 sm:px-4 py-2.5 fixed w-full z-20 top-0 left-0 border-b border-gray-200 ">
        ...
        <ul class="flex flex-row p-1 mt-1 rounded-lg border border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0">
        ${links}
        </ul>
        <div class="relative text-gray-300 w-60 px-2 sm:px-4 py-2.5 mr-2">
              ...
              <input type="search" name="search" id="searchInput" placeholder="Search" class="bg-blue-800 h-10 px-10 pr-5 w-full rounded-full text-sm focus:outline-none bg-purple-white shadow border-0">
