...
function createHeaderBar() {
  ...
  if (navBar) {
    ...
    if (userName) {
      links = `
      <a href="my-posts.html" class="block py-2 p-1 text-lg text-white hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 "> ${userName}'s profile and posts </a>
    </li>    
`;
    }
    navBar.innerHTML = `
    <nav class="px-2 sm:px-4 py-2.5 fixed w-full z-20 top-0 left-0 border-b border-gray-200 bg-blue-500 ">
